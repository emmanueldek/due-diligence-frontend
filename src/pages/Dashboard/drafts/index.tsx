...
import { getDashboardDrafts } from "@/services/dashboardService";
...
const Drafts: React.FC = () => {
  ...
  const { data: darftData, isLoading } = useQuery(["dashDraft", currentPage, debouncedSearchValue], () =>
    getDashboardDrafts(currentPage, debouncedSearchValue),
  );
  useEffect(() => {
