...
const Decline = ({ searchValue }: ISearchValue) => {
  const columns = [
  ...
  const { data: queryData, isLoading } = useQuery(["execDeclined", currentPage, debouncedSearchValue], () =>
    execPendingRequest(currentPage, "declined", debouncedSearchValue),
  );
