...
const Obligation: React.FC<IDataContract> = ({ data }) => {
  const newData: IContractProps[] = data ? data : [];
  ...
  return (
    <div>
      {newData.length === 0 ? (
        ...
        <>
          <div>
            <p className="font-[700] 2xl">Contractual Obligation</p>
                      ...
                      <>
                        ...
                        >
                          {col.field === "coDocuments" ? (
                            ...
                            <>{items[col.field as keyof IContractProps]}</>
                          )}
                        </td>
                      </>
                    );
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-5">
              {newData?.map((item, i) => {
                return (
                  <Link key={i} to={`${item.coDocuments}`}>
